...
**GNSS-INS-SIM** extended with [Deterministic Error Configuration](https://commons.erau.edu/cgi/viewcontent.cgi?article=1001&context=pr-honors-coe#:~:text=Scale%20factor%20errors%20describe%20how,slope%20produced%20by%20the%20IMU.)

Following deterministic errors are supported:

* **Scale Factor Error, K** How well the output of the sensor corresponds to a force or rate input.

* **Misalignment Error, S** Cross-coupling outputs due to imperfect construction or alignment of the three sensing axes in the accelerometer or gyroscope.
